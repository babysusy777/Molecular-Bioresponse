...
SCRIPT_VERSION = "k234-v2-2026-07-22"
RANDOM_STATE = 42
TARGET_COL = "Activity"
...
def main() -> None:
    ...
    # Always export the automatically selected balanced solution.
    save_raw_vs_normalized(
        balanced_solution,
        output_name="05_balanced_selected_embedding.png",
    )

    # Always export k=2, k=3, and k=4 at the same balanced bandwidth.
    # This avoids hiding k=2 when the automatic selector prefers another k
    # and makes the resolution comparison fully reproducible.
    save_raw_vs_normalized(
        balanced_k2,
        output_name="06_balanced_k2_embedding.png",
    )
    save_raw_vs_normalized(
        balanced_k3,
        output_name="07_balanced_k3_embedding_2d_projection.png",
    )
    save_k3_embedding(
        balanced_k3,
        output_name="08_balanced_k3_embedding_3d.png",
    )
    save_raw_vs_normalized(
        balanced_k4,
        output_name="09_balanced_k4_embedding_2d_projection.png",
    )
    save_k4_pairwise_projections(
        balanced_k4,
        output_name="10_balanced_k4_refinement_all_pairs.png",
    )
    save_eigenvalue_spectrum(
        classical_solution,
        balanced_solution,
        output_name="11_eigenvalue_spectra.png",
    )
    save_nesting_heatmap(
        nesting_counts,
        nesting_rows,
        output_name="12_balanced_k2_vs_k4_nesting.png",
    )

    expected_figure_names = [
        "01_classical_model_selection.png",
        "02_classical_selected_embedding.png",
        "03_balanced_model_selection.png",
        "04_weight_sensitivity_ari.png",
        "05_balanced_selected_embedding.png",
        "06_balanced_k2_embedding.png",
        "07_balanced_k3_embedding_2d_projection.png",
        "08_balanced_k3_embedding_3d.png",
        "09_balanced_k4_embedding_2d_projection.png",
        "10_balanced_k4_refinement_all_pairs.png",
        "11_eigenvalue_spectra.png",
        "12_balanced_k2_vs_k4_nesting.png",
    ]
    missing_figures = [
        name for name in expected_figure_names if not (FIGURE_DIR / name).exists()
    ]
    if missing_figures:
        raise RuntimeError(
            "Expected figures were not created: " + ", ".join(missing_figures)
        )
    print("Verified generated figures:")
    ...
    save_coordinates(balanced_k3, "balanced_k3_coordinates")
    ...
    baseline_labels = pd.DataFrame({
        ...
        "mixed_balanced_k3": balanced_k3.labels,
